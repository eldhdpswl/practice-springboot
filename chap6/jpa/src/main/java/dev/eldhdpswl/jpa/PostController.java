...
import dev.eldhdpswl.jpa.aspect.LogExecutionTime;
import dev.eldhdpswl.jpa.aspect.LogArguments;
import dev.eldhdpswl.jpa.aspect.LogReturn;
...
public class PostController {
    ...
    */
    ...
    public PostController(
            ...
            @Autowired Gson gson  //DemoConfig 클래스에서 gson() 함수로 IoC 컨테이너에 넘겨줘서 가능하다.
    ){
    ...
    @GetMapping("test-log")
    public void testLog(){
        // trace, debug는 로그상에 안나온다
        // trace는 사소한 메시지, error로 갈수록 위험한 메시지 
